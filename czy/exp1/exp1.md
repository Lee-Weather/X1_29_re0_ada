...
| exp_ada_2 | 2026-09-02 | 抬腿充分性修复：feet_clearance 奖励连续化（0/1→不足侧高斯梯度）+target 0.045/权重 1.5+踝摆幅下限解耦 0.6+ref_vel_nominal 0.55 补高速推进；直击 1.1 遗留的拖地-踝抖-0.6 档欠速因果链 | 待训练 | 待定 | 待定 | 待定 |
