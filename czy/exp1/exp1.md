...
| exp_ada_1.1 | 2026-09-01 | 微调：新增 gait_symmetry 左右步态镜像对称奖励 1.0（判别实验实锤策略收敛到不对称偏解，假设 B 对策），继承 exp_ada_1 全部配置从零 6000 轮 | 待训练 | 待定 | limxmt8fwmtarfjsiv@emalupe.com | 待定 |
