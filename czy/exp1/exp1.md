...
| exp_ada_1 | 2026-08-31 | 跨版本系列首训：速度域聚焦 [-0.2,0.6]+关闭指令 curriculum+参考摆幅速度自适应（sagittal × step_scale）+**URDF 切回 X1_12DOF 旧约定**+armature 重对齐旧 URDF M_ii；4090D 从零 6000 轮 | 🔄训练中 | TASK_20260901_030 | limxmtcm5s0yriv75d@emalupe.com | 待定 |
