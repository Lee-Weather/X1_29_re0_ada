...
| exp_ada_1.1 | 2026-09-02 | 微调：新增 gait_symmetry 左右步态镜像对称奖励 1.0（判别实验实锤策略收敛到不对称偏解，假设 B 对策），继承 exp_ada_1 全部配置从零 6000 轮；前两次任务（084 config 缺 sym_joint_sign 终止；096/112 排队过久停止），当前 4090D 重跑 | 🔄训练中 | TASK_20260902_009 | limxmt8fwmtarfjsiv@emalupe.com | 待定 |
