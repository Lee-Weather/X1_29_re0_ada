...
| exp_ada_1.5 | 2026-09-03 | 对称幅度强化：1.4 回放发现右腿摆动相抬升仅左脚 54~64%（分段差 30~46%），sym 尾刺加深 0.2×clamp(0,0.5)→0.3×clamp(0,1.0)+权重 1.0→1.5；保留 1.4 全部改动，L4 从零 6000 轮 | 待训练 | 待定 | limxmt8fxevjvx38jd@emalupe.com | 待定 |
