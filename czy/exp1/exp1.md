...
| exp_ada_2 | 2026-09-02 | 抬腿充分性修复：feet_clearance 奖励连续化（0/1→不足侧高斯梯度）+target 0.045/权重 1.5+踝摆幅下限解耦 0.6+ref_vel_nominal 0.55 补高速推进；直击 1.1 遗留的拖地-踝抖-0.6 档欠速因果链。4090D 池(rl-prod)三次卡死(082/083/116)改 L20；换新账号 limxmt8fxevjvx38jd+新项目 PRO_20260902_019 | 🔄训练中（3000 轮） | TASK_20260902_136 | limxmt8fxevjvx38jd@emalupe.com | 待定 |
